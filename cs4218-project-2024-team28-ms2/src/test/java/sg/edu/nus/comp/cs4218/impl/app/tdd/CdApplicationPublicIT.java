...
class CdApplicationPublicIT {
    ...
    @BeforeAll
    static void initialSetup() throws NoSuchFieldException, IllegalAccessException {
    ...
    public void run_CdWithNoArgs_Success() throws Exception {
        TestEnvironmentUtil.setCurrentDirectory(System.getProperty("user.dir")); //added this line
