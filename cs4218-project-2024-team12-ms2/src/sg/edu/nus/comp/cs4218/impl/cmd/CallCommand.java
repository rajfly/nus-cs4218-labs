...
public class CallCommand implements Command {
    ...
    public void evaluate(InputStream stdin, OutputStream stdout)
        ...
        InputStream inputStream = redirHandler.getInputStream(); //NOPMD - suppressed CloseResource - stream closed below
        OutputStream outputStream = redirHandler.getOutputStream(); //NOPMD - suppressed CloseResource - stream closed below
