...
public class ErrorConstants {
    ...
    public static final String ERR_READING_STREAM = "Could not read from input stream";
    ...
    public static final String ERR_ILLEGAL_FLAG = "Illegal option -- ";
    ...
    public static final String ERR_WRITING_TO_FILE = "Could not write to file";
    ...
    // `cp` related
    public static final String ERR_MISSING_SOURCE = "missing file operand";
    public static final String ERR_MISSING_TARGET_FORMAT = "missing destination file operand after '%s'";
    public static final String ERR_SAME_FILE_FORMAT = "'%s' and '%s' are the same file";

    // `mv` related
    public static final String ERR_UNABLE_TO_MOVE = "Unable to move file";

    // `cut` related
    public static final String ERR_INVALID_RANGE = "invalid byte/character range";
    ...
    // 'IORedirection' related
    public static final String ERR_OVERWRITE_EXISTING = "Cannot overwrite existing file";
    public static final String ERR_DIRECTORY_EXISTING = "Cannot overwrite existing directory";
    public static final String ERR_DIRECTORY_NOT_FOUND = "No such directory";
}
