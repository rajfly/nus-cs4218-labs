...
public class WcApplicationPublicTest {
    ...
    void countFromFiles_EmptyFile_ReturnsAllZeros() throws Exception {
        ...
        String expected = String.format(FORMAT_TRIPLE, 0, 0, 0) + SPACE + "file1.txt";
    ...
    void countFromFiles_SingleFileWithSingleLineText_ReturnsLinesWordsBytesCount() throws Exception {
        ...
        String expected = String.format(FORMAT_TRIPLE, 0, 4, BYTECOUNT_SINGLE) + SPACE + "file2.txt";
    ...
    void countFromFiles_SingleFileWithSingleLineTextBytesOption_ReturnBytesCount() throws Exception {
        ...
        String expected = String.format(FORMAT_SINGLE, BYTECOUNT_SINGLE) + SPACE + "file3.txt";
    ...
    void countFromFiles_SingleFileWithSingleLineTextLinesOption_ReturnLinesCount() throws Exception {
        ...
        String expected = String.format(FORMAT_SINGLE, 0) + SPACE + "file4.txt";
    ...
    void countFromFiles_SingleFileWithSingleLineTextWordsOption_ReturnWordsCount() throws Exception {
        ...
        String expected = String.format(FORMAT_SINGLE, 4) + SPACE + "file5.txt";
    ...
    void countFromFileAndStdin_SingleFileWithSingleLineTextAndStdin_ReturnsLinesWordsBytesTotalCount() throws Exception {
        ...
        String expected = String.format(FORMAT_TRIPLE, 0, 4, BYTECOUNT_SINGLE) + SPACE + "file13.txt" + STRING_NEWLINE +
                String.format(FORMAT_TRIPLE, 1, 9, BYTECOUNT_MULTI) + STRING_NEWLINE +
                String.format(FORMAT_TRIPLE, 1, 13, BYTESUM_SINGLE) + SPACE + LABEL_TOTAL;
    ...
    void countFromFileAndStdin_StdinAndSingleFileWithSingleLineText_ReturnsLinesWordsBytesTotalCount() throws Exception {
        ...
        String expected = String.format(FORMAT_TRIPLE, 1, 9, BYTECOUNT_MULTI) + STRING_NEWLINE +
                String.format(FORMAT_TRIPLE, 0, 4, BYTECOUNT_SINGLE) + SPACE + "file14.txt" + STRING_NEWLINE +
                String.format(FORMAT_TRIPLE, 1, 13, BYTESUM_SINGLE) + SPACE + LABEL_TOTAL;
    ...
    void countFromFileAndStdin_SingleFileWithSingleLineTextBytesOptionAndStdin_ReturnBytesTotalCount() throws Exception {
        ...
        String expected = String.format(FORMAT_SINGLE, BYTECOUNT_SINGLE) + SPACE + "file15.txt" + STRING_NEWLINE +
                String.format(FORMAT_SINGLE, BYTECOUNT_MULTI) + STRING_NEWLINE +
                String.format(FORMAT_SINGLE, BYTESUM_SINGLE) + SPACE + LABEL_TOTAL;
    ...
    void countFromFileAndStdin_SingleFileWithSingleLineTextLinesOptionAndStdin_ReturnLinesTotalCount() throws Exception {
        ...
        String expected = String.format(FORMAT_SINGLE, 0) + SPACE + "file16.txt" + STRING_NEWLINE +
                String.format(FORMAT_SINGLE, 1) + STRING_NEWLINE +
                String.format(FORMAT_SINGLE, 1) + SPACE + LABEL_TOTAL;
    ...
    void countFromFileAndStdin_SingleFileWithSingleLineTextWordsOption_ReturnWordsTotalCount() throws Exception {
        ...
        String expected = String.format(FORMAT_SINGLE, 4) + SPACE + "file17.txt" + STRING_NEWLINE +
                String.format(FORMAT_SINGLE, 9) + STRING_NEWLINE +
                String.format(FORMAT_SINGLE, 13) + SPACE + LABEL_TOTAL;
