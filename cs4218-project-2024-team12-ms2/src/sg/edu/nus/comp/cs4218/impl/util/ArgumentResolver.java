...
public class ArgumentResolver {
    ...
    /**
     * Create a new RegexArgument object.
     *
     * @return A new RegexArgument object.
     */
    ...
    /**
     * Create a new RegexArgument object with the given string.
     *
     * @param str The string to be used in the new RegexArgument object.
     * @return A new RegexArgument object with the given string.
     */
    ...
    /**
     * Evaluate a sub-command and return the output.
     *
     * @param commandString The sub-command to be evaluated.
     * @return The output of the sub-command.
     * @throws AbstractApplicationException If an exception occurs while running the sub-command.
     * @throws ShellException               If an exception occurs while running the sub-command.
     * @throws FileNotFoundException         If an exception occurs while running the sub-command.
     */
