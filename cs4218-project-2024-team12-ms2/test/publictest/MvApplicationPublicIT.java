...
public class MvApplicationPublicIT {
    ...
    public void run_WithoutFlagsSameSrcAndDestExist_NoChange() throws Exception {
        ...
        MvException mvException = assertThrows(MvException.class, () -> mvApplication.run(argList, System.in, output));
        ...
        assertEquals(FILE1_CONTENTS, expectedNewFileContents.get(0));
        String expectedMsg = String.format("mv: " + ERR_SAME_FILE_FORMAT, FILE_1_TXT, FILE_1_TXT);
        assertEquals(expectedMsg, mvException.getMessage());
    }
