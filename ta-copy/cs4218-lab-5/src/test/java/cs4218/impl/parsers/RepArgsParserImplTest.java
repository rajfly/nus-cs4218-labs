...
class RepArgsParserImplTest {
    ...
    void getMode_WithFlag_ReplaceCharactersModeSelected() throws RepException {
        parser.parseAndValidate(Arrays.asList("-c", "pattern", "replacement", "path"));
    ...
    class TypicalValues {
        ...
        void setUp() throws RepException {
            ...
            parser.parseAndValidate(Arrays.asList("hello", "world", filePath));
        }

        @Test
        void getPattern_TypicalValues_ReturnsCorrectValue() {
        ...
        @Test
        void getReplacement_TypicalValues_ReturnsCorrectValue() {
        ...
        @Test
        void getFilePath_TypicalValues_ReturnsCorrectValue() {
